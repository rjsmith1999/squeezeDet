...
if __name__ == "__main__":
  ...
  parser.add_argument(
      ...
      must be passed in.\
      """)
  # stuffs = "--input_graph ./squeezeDet.pb --input_checkpoint ../data/model_checkpoints/squeezeDet/model.ckpt-87000 --input_meta_graph ../data/model_checkpoints/squeezeDet/model.ckpt-87000.meta  --output_node_names bbox, prob, cls_id --input_binary true"
